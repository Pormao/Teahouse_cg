...
<?= $form->field($uploadModel, 'file')->fileInput(['id'=>"uploadFileInput",'class'=>"upload_file",'onpropertychange'=>'this.form.submit()','onchange'=>"this.form.submit()",'multiple' => true])->label(false); ?>
<?php ActiveForm::end() ?>	
</div>
